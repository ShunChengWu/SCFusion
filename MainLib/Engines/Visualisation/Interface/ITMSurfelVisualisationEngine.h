...
namespace ITMLib {
    ...
    public:
        ...
        static std::string toString(RenderImageType type) {
            switch (type) {
                case RENDER_DEPTH:
                    return "RENDER_DEPTH";
                case RENDER_VERTEX:
                ...
                case RENDER_CONFIDENCE:
                    return "RENDER_CONFIDENCE";
                case RENDER_FLAT:
                    return "RENDER_FLAT";
                case RENDER_LAMBERTIAN:
                    return "RENDER_LAMBERTIAN";
                case RENDER_NORMAL:
                    return "RENDER_NORMAL";
                case RENDER_PHONG:
                    return "RENDER_PHONG";
                case RENDER_LABELCOLOUR:
                    return "RENDER_LABELCOLOUR";
                default:
                    throw std::runtime_error("Given type is not listed yet!\n");
    ...
    public:
        ...
        virtual void CreateICPMaps(const ITMSurfelScene<TSurfel> *scene, const ITMSurfelRenderState *renderState,
                                   ITMTrackingState *trackingState) const = 0;
        ...
        virtual void RenderLabel(const ITMSurfelScene<TSurfel> *scene, const ORUtils::SE3Pose *pose,
                                 const ITMSurfelRenderState *renderState,
    ...
    public:
         ...
         */
        void
        FindSurface(const ITMSurfelScene<TSurfel> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                    bool useRadii, UnstableSurfelRenderingMode unstableSurfelRenderingMode,
         ...
         * \param renderState                   The render state in which to store the index image.
         */
        void FindSurfaceSuper(const ITMSurfelScene<TSurfel> *scene, const ORUtils::SE3Pose *pose,
                              const ITMIntrinsics *intrinsics,
                              UnstableSurfelRenderingMode unstableSurfelRenderingMode,
                              ITMSurfelRenderState *renderState) const;

        void SetLabelColorListPtr(const ORUtils::MemoryBlock<Vector4f> *labelColorList) {this->labelColorList_ = labelColorList;}

    protected:
        const ORUtils::MemoryBlock<Vector4f> *labelColorList_;
    ...
    private:
         ...
         */
        virtual void MakeIndexImage(const ITMSurfelScene<TSurfel> *scene, const ORUtils::SE3Pose *pose,
                                    const ITMIntrinsics *intrinsics,
                                    int width, int height, int scaleFactor, unsigned int *surfelIndexImage,
                                    bool useRadii,
                                    UnstableSurfelRenderingMode unstableSurfelRenderingMode,
