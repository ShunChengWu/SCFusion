...
namespace ITMLib
{
	...
	public:
		...
		enum RenderImageType
		{
            ...
            RENDER_LABELCOLOUR_FROM_VOLUME,
            RENDER_LABELCOLOUR_FROM_IMAGENORMALS,
            RENDER_COLOUR_FROM_SEMANTIC_LABEL
		};
        ...
        IITMVisualisationEngine():labelColorList(nullptr){}
        virtual ~IITMVisualisationEngine() {}
		...
		void setLabelColorListPtr(const Vector4f  * labelColorList_) {this->labelColorList = labelColorList_;}
	...
	{
    public:
        using IITMVisualisationEngine::labelColorList;
        ITMVisualisationEngine()= default;
        ~ITMVisualisationEngine()= default;
		...
		*/
		...
		an image.
		*/
		virtual void CreateExpectedDepths(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics, const Vector2f &viewFrustumRange,
			ITMRenderState *renderState) const = 0;
		...
		virtual void GetDepthImage(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                         const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                         ITMFloatImage *outputImage) const = 0;

        virtual void GetVertexImage(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                                 const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                                 ITMFloat3Image *outputImage) const = 0;

        virtual void GetVertexImage(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                                    const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                                    ITMFloat4Image *outputImage) const = 0;

        virtual void GetNormalImage(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                                    const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                                    ITMFloat4Image *outputImage) const = 0;

        virtual void GetLabelImage(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                                    const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                                    ITMUShortImage *outputImage) const = 0;

        virtual void GetSemanticImage(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                                   const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                                   ITMUShortImage *outputImage) const = 0;
		...
		virtual void FindSurface(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
			const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode) const = 0;
		...
		*/
		virtual void CreatePointCloud(const ITMScene<TVoxel,TIndex> *scene, const ITMView *view, ITMTrackingState *trackingState, 
			ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode, bool skipPoints) const = 0;
		...
		*/
		virtual void CreateICPMaps(const ITMScene<TVoxel,TIndex> *scene, const ITMView *view, ITMTrackingState *trackingState,
		        ITMRenderState *renderState,ITMLib::IITMVisualisationEngine::RenderMode renderMode) const = 0;
