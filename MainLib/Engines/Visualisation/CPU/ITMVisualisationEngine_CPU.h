...
namespace ITMLib
{
	...
	public:
		...
		void CreateExpectedDepths(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics, const Vector2f &viewFrustumRange, ITMRenderState *renderState) const;
        ...
        void GetDepthImage(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                         const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                         ITMFloatImage *outputImage) const { throw SCFUSION::ERROR_NotImplemented(__FUNCTION__); }
        void GetVertexImage(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                          const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                          ITMFloat3Image *outputImage) const { throw SCFUSION::ERROR_NotImplemented(__FUNCTION__);}
        void GetVertexImage(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                            const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                            ITMFloat4Image *outputImage) const  {throw SCFUSION::ERROR_NotImplemented(__FUNCTION__); }
        void GetNormalImage(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                            const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                            ITMFloat4Image *outputImage) const  {throw SCFUSION::ERROR_NotImplemented(__FUNCTION__); }
        void GetLabelImage(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                                   const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                                   ITMUShortImage *outputImage) const { throw SCFUSION::ERROR_NotImplemented(__FUNCTION__); }
        void GetSemanticImage(const ITMScene<TVoxel,TIndex> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                              const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                              ITMUShortImage *outputImage) const {throw SCFUSION::ERROR_NotImplemented(__FUNCTION__); }
	...
	public:
		...
		void CreateExpectedDepths(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics, const Vector2f &viewFrustumRange, ITMRenderState *renderState) const;
		void RenderImage(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
		        const ITMRenderState *renderState,ITMLib::IITMVisualisationEngine::RenderMode renderMode,
			ITMUChar4Image *outputImage, IITMVisualisationEngine::RenderImageType type = IITMVisualisationEngine::RENDER_SHADED_GREYSCALE,
			IITMVisualisationEngine::RenderRaycastSelection raycastType = IITMVisualisationEngine::RENDER_FROM_NEW_RAYCAST) const override ;
        void GetDepthImage(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                         const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                         ITMFloatImage *outputImage) const { throw SCFUSION::ERROR_NotImplemented(__FUNCTION__); };
        void GetVertexImage(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                          const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                          ITMFloat3Image *outputImage) const;
        void GetVertexImage(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                            const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                            ITMFloat4Image *outputImage) const  {throw SCFUSION::ERROR_NotImplemented(__FUNCTION__); }
        void GetNormalImage(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                            const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                            ITMFloat4Image *outputImage) const  {throw SCFUSION::ERROR_NotImplemented(__FUNCTION__); }
        void GetLabelImage(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                           const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                           ITMUShortImage *outputImage) const { throw SCFUSION::ERROR_NotImplemented(__FUNCTION__); };
        void GetSemanticImage(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics,
                              const ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode,
                              ITMUShortImage *outputImage) const {throw SCFUSION::ERROR_NotImplemented(__FUNCTION__); }
		void FindSurface(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics, const ITMRenderState *renderState,ITMLib::IITMVisualisationEngine::RenderMode renderMode) const;
		...
		void CreateICPMaps(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ITMView *view, ITMTrackingState *trackingState,
				ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode) const override;
		void ForwardRender(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ITMView *view, ITMTrackingState *trackingState,
				ITMRenderState *renderState, ITMLib::IITMVisualisationEngine::RenderMode renderMode) const override ;
	};
}
