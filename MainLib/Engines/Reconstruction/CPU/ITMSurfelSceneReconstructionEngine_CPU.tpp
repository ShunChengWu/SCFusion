...
void ITMSurfelSceneReconstructionEngine_CPU<TSurfel>::AddNewSurfels(ITMSurfelScene<TSurfel> *scene, const ITMView *view, const ITMTrackingState *trackingState) const
{
  ...
  const ushort *labelMap = view->label? view->label->GetDataConst(MEMORYDEVICE_CPU) : nullptr;
  ...
  {
    add_new_surfel(
      locId, T, this->m_timestamp, newPointsMask, newPointsPrefixSum, vertexMap, normalMap, radiusMap, colourMap, labelMap,
...
void ITMSurfelSceneReconstructionEngine_CPU<TSurfel>::FuseMatchedPoints(ITMSurfelScene<TSurfel> *scene, const ITMView *view, const ITMTrackingState *trackingState) const
{
  ...
  {
    fuse_matched_point(
      locId, correspondenceMap, T, this->m_timestamp, vertexMap, normalMap, radiusMap, colourMap, labelMap, depthMapWidth, depthMapHeight, colourMapWidth, colourMapHeight,
