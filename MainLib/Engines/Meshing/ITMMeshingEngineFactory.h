...
namespace ITMLib
{
	...
	struct ITMMeshingEngineFactory
	{
		...
		static ITMMeshingEngine<TVoxel, TIndex> *MakeMeshingEngine(ITMLibSettings::DeviceType deviceType, float isoValue = 0.f)
		{
			...
			case ITMLibSettings::DEVICE_CPU:
				meshingEngine = new ITMMeshingEngine_CPU<TVoxel, TIndex> (isoValue);
				break;
			case ITMLibSettings::DEVICE_CUDA:
#ifndef COMPILE_WITHOUT_CUDA
				meshingEngine = new ITMMeshingEngine_CUDA<TVoxel, TIndex> (isoValue);
#endif
				break;
