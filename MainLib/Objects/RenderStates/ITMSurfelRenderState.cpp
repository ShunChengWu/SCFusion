...
ITMSurfelRenderState::ITMSurfelRenderState(const Vector2i& indexImageSize, int supersamplingFactor)
{
  ...
  raycastLabel = new ORUtils::Image<ushort>(indexImageSize, true, true);
}
...
const ORUtils::Image<unsigned int> *ITMSurfelRenderState::GetIndexImageSuper() const
{
  return surfelIndexImageSuper;
    ...
    ORUtils::Image<ushort> *ITMSurfelRenderState::GetLabelBuffer() {
      return raycastLabel;
    }

    ORUtils::Image<ushort> *ITMSurfelRenderState::GetLabelBuffer() const {
      return raycastLabel;
    }
