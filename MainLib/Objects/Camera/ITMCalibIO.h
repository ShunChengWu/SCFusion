...
namespace ITMLib
{
    ...
    bool readDistortionCalib(std::istream & src, ITMDistortionCalib &dest);
    bool readDistortionCalib(const char *fileName, ITMDistortionCalib &dest);
	bool readRGBDCalib(std::istream & src, ITMRGBDCalib & dest);
	bool readRGBDCalib(const char *fileName, ITMRGBDCalib & dest);
	bool readRGBDCalib(const char *rgbIntrinsicsFile, const char *depthIntrinsicsFile, const char *disparityCalibFile, const char *extrinsicsFile, const char * distortionCalibFile, ITMRGBDCalib & dest);
