	...
	*/
	...
	public:
		...
		*/
        ...
        /// Distortion information to un-distort the input image
        ITMDistortionCalib distortionCalib_rgb;
        ITMDistortionCalib distortionCalib_d;
	};
}
