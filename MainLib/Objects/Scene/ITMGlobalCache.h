...
namespace ITMLib
{
	...
	public:
        ...
        /** a vector of 獲得swap的狀態：
         0 - host memory: 1; active memory 0
         1 - host memory: 1; active memory 1
         2 - host memory: 0; active memory 1
         資料有順序性
        */
		ITMHashSwapState *GetSwapStates(bool useGPU) { return useGPU ? swapStates_device : swapStates_host; }
        /// a vector of 需要entry的id: 儲存的是indices which point to the entry id
