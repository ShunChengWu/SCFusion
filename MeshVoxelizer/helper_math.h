...
inline _CPU_AND_GPU_CODE_ float norm(float3 a, float3 b)
{
    return sqrt(dot(a,b));
}
...
// bool
////////////////////////////////////////////////////////////////////////////////
inline _CPU_AND_GPU_CODE_ bool operator==(int3 a, int3 b){
    return a.x==b.x && a.y ==b.y && a.z==b.x;
}
inline _CPU_AND_GPU_CODE_ bool operator==(float3 a, float3 b){
    return a.x==b.x && a.y ==b.y && a.z==b.x;
}
inline _CPU_AND_GPU_CODE_ bool operator==(float2 a, float b)
{
    return a.x == b && a.y == b;
}

inline _CPU_AND_GPU_CODE_ bool operator==(float3 a, float b)
{
